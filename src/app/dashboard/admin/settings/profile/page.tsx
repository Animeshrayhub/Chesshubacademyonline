export default function ProfileSettingsPage() {
  return (
    <div className="bg-white rounded-2xl border border-border shadow-card p-6 max-w-2xl">
      <h3 className="text-base font-bold text-text-primary mb-4">Admin Profile Preferences</h3>

      <div className="space-y-4">
        <div>
          <label className="block text-sm font-semibold text-text-primary mb-2">Display Username</label>
          <input
            type="text"
            defaultValue="Academy Admin"
            disabled
        ...
        <div>
          <label className="block text-sm font-semibold text-text-primary mb-2">Administrator Title</label>
          <input
            type="text"
            defaultValue="Lead Portal Administrator"
            disabled
            className="w-full px-4 py-3 rounded-xl border border-border bg-surface-light text-text-primary text-sm focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
